...
export const EN_PLAIN: Record<string, string> = {
  ...
  "会话文件": "Session file",
  "会话导入": "Session import",
  "从市场重新安装": "Reinstall from marketplace",
  "从社区重新安装": "Reinstall from community",
  "重新导入": "Import again",
  "清空草稿": "Clear draft",
  "损坏": "Damaged",
  "主题文件缺失或损坏": "Theme files are missing or damaged",
  "请先从“我的主题”选择一个主题，或从图片创建新主题。":
    "Select a theme from My Themes or create one from an image first.",
  "实时皮肤已清理，重启后 Codex 原始基础外观完整生效。":
    "The live skin has been cleared. Restart Codex to fully restore its original appearance.",
